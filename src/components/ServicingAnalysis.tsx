...
import { TrendingUp, TrendingDown, Calendar, BarChart3, PieChartIcon, Layers } from 'lucide-react';
...
export default function ServicingAnalysis() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
        <h3 className="text-white font-medium mb-4">All Categories</h3>
      ...
      {/* Projects included */}
      <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
        <h3 className="text-white font-medium mb-4">Servicing Projects Included</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {data.projects.map((project) => (
            <div key={project.name} className="bg-gray-700/50 rounded-lg p-3">
              <div className="text-gray-400 text-sm truncate">{project.name}</div>
